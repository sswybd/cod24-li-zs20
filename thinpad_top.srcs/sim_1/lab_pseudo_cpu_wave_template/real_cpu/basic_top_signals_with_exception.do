...
add wave -noupdate /tb/dut/mem_stage_csr_rd_addr
add wave -noupdate /tb/dut/mem_stage_csr_rd_data
add wave -noupdate /tb/dut/fetched_instr
...
add wave -noupdate /tb/dut/pc_is_from_branch
...
add wave -noupdate /tb/dut/decoded_csr_rd_addr
...
add wave -noupdate /tb/dut/exe_stage_csr_rd_addr
...
add wave -noupdate /tb/dut/mtvec_csr
add wave -noupdate /tb/dut/mscratch_csr
add wave -noupdate /tb/dut/mepc_csr
add wave -noupdate /tb/dut/mcause_csr
add wave -noupdate /tb/dut/mstatus_csr
add wave -noupdate /tb/dut/mie_csr
add wave -noupdate /tb/dut/mip_csr
...
add wave -noupdate /tb/dut/rxd
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {4176216 ps} 0}
