...
add wave -noupdate /tb/dut/data_mem_and_peripheral_ack
add wave -noupdate /tb/dut/instruction_mem_ack
...
add wave -noupdate /tb/dut/if_stage_instr_o
...
WaveRestoreCursors {{Cursor 1} {208004910 ps} 0}
...
update
WaveRestoreZoom {207191947 ps} {209443349 ps}
