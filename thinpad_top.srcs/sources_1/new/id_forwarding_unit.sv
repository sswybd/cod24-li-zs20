...
assign forward_a_o = (csr_wb_en_i && (rf_raddr_a == mem_stage_rd_addr_i) && (mem_stage_rd_addr_i != 'd0)) ? 2'b10 :
                     (wb_en && (wb_addr == rf_raddr_a) && (wb_addr != 'd0)) ? 2'b01 :
                      2'b00;

assign forward_b_o = (csr_wb_en_i && (rf_raddr_b == mem_stage_rd_addr_i) && (mem_stage_rd_addr_i != 'd0)) ? 2'b10 :
